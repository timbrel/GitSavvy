    ...
    def auto_squash(self, commit_chain):
        ...
        if m:
            ...
            if orig_commit_indx >= 0:
                ...
                commit_chain[orig_commit_indx + 1].msg = commit_chain[orig_commit_indx].msg
                commit_chain[orig_commit_indx + 1].datetime = commit_chain[orig_commit_indx].datetime
                commit_chain[orig_commit_indx + 1].author = commit_chain[orig_commit_indx].author
                commit_chain[orig_commit_indx + 1].modified = True
