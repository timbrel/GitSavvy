...
class GsDiffCommand(WindowCommand, GitCommand):
    ...
    display a diff of the Git index. Set `ready_only` to True to
    ...
    def run_async(self, in_cached_mode=False, file_path=None,
                  current_file=False, base_commit=None, target_commit=None, ready_only=False):
        ...
        if view_key in diff_views and diff_views[view_key] in sublime.active_window().views():
            ...
            diff_view.settings().set("git_savvy.diff_view.ready_only", ready_only)
