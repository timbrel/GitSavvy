...
class GsGithubShowGithubIssuesCommand(TextCommand, GitCommand, git_mixins.GithubRemotesMixin):
...
class GsGithubShowGithubContributorsCommand(TextCommand, GitCommand):
