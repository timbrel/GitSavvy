...
class TestAppState(DeferrableTestCase):
    def setUp(self):
        ...
        self.old_cache_path = app_state.CACHE_PATH
        self.old_state_path = app_state.STATE_PATH
        self.old_temp_path = app_state.TEMP_PATH
        self.old_sublime = app_state.sublime

        app_state._state = {}
        app_state._save_scheduled = False
        app_state._repo_state_pruned = False
        app_state.CACHE_PATH = self.temp_dir.name
        app_state.STATE_PATH = os.path.join(self.temp_dir.name, "state.json")
        app_state.TEMP_PATH = app_state.STATE_PATH + ".tmp"
    ...
    def tearDown(self):
        ...
        app_state.CACHE_PATH = self.old_cache_path
        app_state.STATE_PATH = self.old_state_path
        app_state.TEMP_PATH = self.old_temp_path
    ...
    def test_round_trips_state_through_disk(self):
        ...
        with open(app_state.STATE_PATH, encoding="utf-8") as file:
    ...
    def test_ignores_a_non_object_state_file(self):
        os.makedirs(os.path.dirname(app_state.STATE_PATH), exist_ok=True)
        with open(app_state.STATE_PATH, "w", encoding="utf-8") as file:
