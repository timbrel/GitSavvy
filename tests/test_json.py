...
Original file can be found at:
  ...
  https://github.com/facelessuser/sublime-markdown-popups/tree/master/tests

The original validate_json_format.py was merged into test_json.py and some
smaller changes to satisfy most linters were applied by <deathaxe@gmail.com>
"""
import codecs
import fnmatch
import json
